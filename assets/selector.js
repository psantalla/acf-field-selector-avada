...
class ACFFieldSelector {
    ...
    getConfig() {
        return {
            ...
            title: '.dynamic-title h3, .option-details h3 span',
    ...
    filterFields(type) {
        const filters = {
            // 'all' excludes only repeaters. Relationships are included because Avada uses them for filtering (e.g., filter posts by current page ID)
